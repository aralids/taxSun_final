...
var PlotDrawing = /** @class */ (function (_super) {
    ...
    PlotDrawing.prototype.assignDegrees = function (newState) {
        ...
        console.log("structureByDegrees: ", structureByDegrees);
    ...
    PlotDrawing.prototype.getStructureByTaxon = function (newState) {
        ...
        console.log("taxonSpecifics: ", newState["taxonSpecifics"]);
        console.log("structureByTaxon: ", newState["structureByTaxon"]);
...
console.log("root, c.o.: ", allTaxaReduced["root"], allTaxaReduced["cellular organisms"]);
